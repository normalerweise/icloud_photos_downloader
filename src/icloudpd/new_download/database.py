...
class PhotoDatabase:
    ...
    def get_asset(self, asset_id: str) -> PhotoAssetRecord | None:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            asset_data = dict(zip(columns, row, strict=False))
    ...
    def update_download_status(
        self, asset_id: str, downloaded_versions: List[str], failed_versions: List[str]
    ) -> None:
